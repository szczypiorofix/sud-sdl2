...
int LevelParser::_new(lua_State* L) {
    ...
    void* pointerToLevel = lua_newuserdata(L, sizeof(LuaLevel));
    LuaLevel* level = new (pointerToLevel) LuaLevel();
...
int LevelParser::_index(lua_State* L) {
    ...
    LuaLevel* level = (LuaLevel*)lua_touserdata(L, -2);
...
int LevelParser::_newindex(lua_State* L) {
    ...
    LuaLevel* level = (LuaLevel*)lua_touserdata(L, -3);
...
LuaLevel* LevelParser::GetLevel(lua_State* L, const char* objectName) {
