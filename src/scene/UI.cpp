...
void UI::_drawGenericButton() {
	...
	SDL_Color oldColor;
	SDL_GetRenderDrawColor(GameSystem::GetInstance()->GetRenderer(), &oldColor.r, &oldColor.g, &oldColor.b, &oldColor.a);
	SDL_SetRenderDrawColor(GameSystem::GetInstance()->GetRenderer(), props->BackgroundColor.r, props->BackgroundColor.g, props->BackgroundColor.b, props->BackgroundColor.a);

	SDL_RenderFillRect(GameSystem::GetInstance()->GetRenderer(), &rect);

	props->_font->Draw(L"Reload", (int)(props->pos.X + 5.0), (int)(props->pos.Y + 5.0), 1.0f, props->FontColor);

	SDL_SetRenderDrawColor(GameSystem::GetInstance()->GetRenderer(), oldColor.r, oldColor.g, oldColor.b, oldColor.a);
